...
| ✅     | DevOps, Testing | CI/CD Integration for Automated Tests | DevOps      | Jenkins, GitHub     | 2024-08-15     | Runs nightly regression    |
...
- ✅ Write and run your first automated test ([NUnit Getting Started](https://docs.nunit.org/articles/nunit/intro.html))  
- 🎯 [Use basic assertions](https://docs.nunit.org/articles/nunit/writing-tests/assertions/classic-model.html) (`equals`, `true/false`, `not null`)  
- 🎯 [Organize tests using a testing framework](https://docs.nunit.org/articles/nunit/writing-tests/attributes.html) (e.g., NUnit, TestNG, PyTest)  
...
- ✅ [Push automation code to GitHub](https://docs.github.com/en/get-started/quickstart/create-a-repo) / GitLab / Bitbucket  
- ✅ Help a teammate debug their automation code  
- 🎯 [Write data-driven tests](https://docs.nunit.org/articles/nunit/writing-tests/attributes/testcase-source.html) (CSV, JSON, Excel, database)  
...
- 🎯 [Automate mobile apps with Appium](https://appium.io/docs/en/about-appium/intro/) or Playwright Mobile  
